...
export const strings = {
  ...
  // --- Community: nav ---
  community_nav: { hi: 'समुदाय', en: 'Community' },

  // --- Community error messages ---
  err_question_required: { hi: 'कृपया अपना सवाल लिखें।', en: 'Please write your question.' },
  err_story_required: { hi: 'कृपया अपनी कहानी लिखें।', en: 'Please write your story.' },
  err_story_fields_required: { hi: 'नाम, कहानी और मदद का विवरण ज़रूरी है।', en: 'Name, story and how-helped are required.' },
  err_scheme_fields_required: { hi: 'योजना के ज़रूरी फ़ील्ड भरें।', en: 'Please fill the required scheme fields.' },
  err_invalid_scheme_category: { hi: 'योजना की श्रेणी अमान्य है।', en: 'Invalid scheme category.' },
  ...
  sawaal_answered_by: { hi: 'जवाब — ', en: 'Answered by ' },
  sawaal_show_answer: { hi: 'जवाब देखें', en: 'Show answer' },
  sawaal_hide_answer: { hi: 'जवाब छिपाएं', en: 'Hide answer' },
  sawaal_submitted: { hi: 'आपका सवाल मिल गया। हम जल्द जवाब देंगे।', en: "Your question received. We'll answer soon." },
  sawaal_ask_note: { hi: 'आपका सवाल जांच के बाद जवाब के साथ प्रकाशित किया जाएगा।', en: 'Your question will be published with an answer after review.' },
  sawaal_f_name: { hi: 'आपका नाम (वैकल्पिक)', en: 'Your name (optional)' },
  sawaal_f_village: { hi: 'गांव / शहर', en: 'Village / Town' },
  ...
  scat_land: { hi: 'ज़मीन', en: 'Land' },
  scat_equipment: { hi: 'उपकरण', en: 'Equipment' },
  scat_crop: { hi: 'फसल', en: 'Crop' },
  scat_pest: { hi: 'कीट', en: 'Pest' },
  scat_weather: { hi: 'मौसम', en: 'Weather' },
  scat_market: { hi: 'बाज़ार', en: 'Market' },
  scat_scheme: { hi: 'योजनाएं', en: 'Schemes' },
  scat_drone_didi: { hi: 'ड्रोन दीदी', en: 'Drone Didi' },
  scat_general: { hi: 'सामान्य', en: 'General' },

  // --- Kisan Safalta (success stories) ---
  safalta_nav: { hi: 'किसान सफलता', en: 'Stories' },
  safalta_title: { hi: 'किसान सफलता — जब किसान जीतता है', en: 'Kisan Safalta — When the Farmer Wins' },
  safalta_sub: { hi: 'सागर जिले के किसानों की असली कहानियां', en: 'Real stories of farmers from Sagar district' },
  safalta_empty: {
    hi: 'सफलता की कहानियां जल्द आ रही हैं। क्या आपके पास एक कहानी है? हमें बताएं: admin@kissansahyog.com',
    en: 'Success stories coming soon. Do you have a story? Tell us: admin@kissansahyog.com',
  },
  ...
  safalta_submitted: { hi: 'आपकी कहानी मिल गई। जांच के बाद हम इसे प्रकाशित करेंगे।', en: "Your story received. We'll publish it after review." },
  safalta_f_name: { hi: 'किसान का नाम', en: 'Farmer name' },
  safalta_f_village: { hi: 'गांव', en: 'Village' },
  safalta_f_crop: { hi: 'फसल / काम', en: 'Crop / Activity' },
  safalta_f_story: { hi: 'आपकी कहानी', en: 'Your story' },
  safalta_f_phone: { hi: 'संपर्क नंबर (वैकल्पिक)', en: 'Contact number (optional)' },

  // --- Sarkari Yojana (schemes) ---
  yojana_nav: { hi: 'सरकारी योजनाएं', en: 'Schemes' },
  yojana_title: { hi: 'सरकारी योजनाएं — किसानों के लिए सरकारी मदद', en: 'Sarkari Yojana — Government Help for Farmers' },
  yojana_sub: { hi: 'जानें कौन सी योजना आपके लिए है और कैसे आवेदन करें', en: 'Learn which scheme is for you and how to apply' },
  yojana_empty: { hi: 'अभी कोई योजना उपलब्ध नहीं है।', en: 'No schemes available right now.' },
  yojana_benefit_label: { hi: 'मुख्य लाभ', en: 'Key benefit' },
  yojana_eligibility_label: { hi: 'कौन आवेदन कर सकता है', en: 'Who can apply' },
  yojana_howto_label: { hi: 'कैसे आवेदन करें', en: 'How to apply' },
  yojana_helpline: { hi: 'हेल्पलाइन', en: 'Helpline' },
  yojana_website: { hi: 'आधिकारिक वेबसाइट', en: 'Official website' },
  yojana_deadline_label: { hi: 'अंतिम तिथि', en: 'Deadline' },
  yojana_ministry_label: { hi: 'मंत्रालय', en: 'Ministry' },
  yojana_show_more: { hi: 'और जानकारी', en: 'More details' },
  yojana_show_less: { hi: 'कम दिखाएं', en: 'Show less' },
  yojana_msp_crosslink: {
    hi: 'फसल का सही दाम जानें → मंडी भाव और MSP की तुलना देखें',
    en: 'Know the right price for your crop → see mandi vs MSP comparison',
  },

  // Yojana category filter labels (+ 'all')
  ycat_all: { hi: 'सभी', en: 'All' },
  ycat_income_support: { hi: 'आय सहायता', en: 'Income support' },
  ycat_crop_insurance: { hi: 'फसल बीमा', en: 'Crop insurance' },
  ycat_credit: { hi: 'लोन', en: 'Credit' },
  ycat_equipment: { hi: 'उपकरण', en: 'Equipment' },
  ycat_solar: { hi: 'सौर ऊर्जा', en: 'Solar' },
  ycat_storage: { hi: 'भंडारण', en: 'Storage' },
  ycat_women: { hi: 'महिला', en: 'Women' },
  ycat_general: { hi: 'सामान्य', en: 'General' },
  ycat_market: { hi: 'बाज़ार', en: 'Market' },

  // --- Homepage community strips ---
  home_sawaal_title: { hi: 'आज का सवाल', en: "Today's Question" },
  home_sawaal_link: { hi: 'सभी सवाल देखें', en: 'See all questions' },
  home_safalta_title: { hi: 'किसान सफलता', en: 'Kisan Safalta' },
  home_safalta_link: { hi: 'सभी कहानियां', en: 'All stories' },

  // --- Info page schemes section ---
  info_yojana_heading: { hi: 'सरकारी योजनाएं', en: 'Government Schemes' },
  info_yojana_link: { hi: 'पूरी सूची', en: 'Full list' },

  // --- Admin: community management ---
  admin_sawaal: { hi: 'किसान सवाल प्रबंधन', en: 'Kisan Sawaal Management' },
  admin_safalta: { hi: 'किसान सफलता प्रबंधन', en: 'Kisan Safalta Management' },
  admin_yojana: { hi: 'सरकारी योजना प्रबंधन', en: 'Sarkari Yojana Management' },
  admin_answer_publish: { hi: 'जवाब दें और प्रकाशित करें', en: 'Answer & Publish' },
  admin_review_publish: { hi: 'समीक्षा करें और प्रकाशित करें', en: 'Review & Publish' },
  admin_pending_badge: { hi: 'लंबित', en: 'Pending' },
  action_feature: { hi: 'फीचर करें', en: 'Feature' },
  action_unfeature: { hi: 'फीचर हटाएं', en: 'Unfeature' },
  featured_badge: { hi: 'फीचर्ड', en: 'Featured' },
  f_answer_hi: { hi: 'जवाब (हिंदी)', en: 'Answer (Hindi)' },
  f_answer_en: { hi: 'जवाब (English)', en: 'Answer (English)' },
  f_answered_by: { hi: 'जवाब देने वाला', en: 'Answered by' },
  f_scheme_name_hi: { hi: 'योजना नाम (हिंदी)', en: 'Scheme name (Hindi)' },
  f_scheme_name_en: { hi: 'योजना नाम (English)', en: 'Scheme name (English)' },
  f_ministry_hi: { hi: 'मंत्रालय (हिंदी)', en: 'Ministry (Hindi)' },
  f_ministry_en: { hi: 'मंत्रालय (English)', en: 'Ministry (English)' },
  f_scheme_category: { hi: 'श्रेणी', en: 'Category' },
  f_benefit_hi: { hi: 'मुख्य लाभ (हिंदी)', en: 'Benefit (Hindi)' },
  f_benefit_en: { hi: 'मुख्य लाभ (English)', en: 'Benefit (English)' },
  f_eligibility_hi: { hi: 'पात्रता (हिंदी)', en: 'Eligibility (Hindi)' },
  f_eligibility_en: { hi: 'पात्रता (English)', en: 'Eligibility (English)' },
  f_howto_hi: { hi: 'आवेदन कैसे करें (हिंदी)', en: 'How to apply (Hindi)' },
  f_howto_en: { hi: 'आवेदन कैसे करें (English)', en: 'How to apply (English)' },
  f_helpline: { hi: 'हेल्पलाइन', en: 'Helpline' },
  f_deadline_hi: { hi: 'अंतिम तिथि नोट (हिंदी)', en: 'Deadline note (Hindi)' },
  f_deadline_en: { hi: 'अंतिम तिथि नोट (English)', en: 'Deadline note (English)' },
  f_farmer_name: { hi: 'किसान का नाम', en: 'Farmer name' },
  f_crop_activity: { hi: 'फसल / काम', en: 'Crop / Activity' },
  f_story_hi: { hi: 'कहानी (हिंदी)', en: 'Story (Hindi)' },
  f_story_en: { hi: 'कहानी (English)', en: 'Story (English)' },
  f_income_before: { hi: 'पहले की आय', en: 'Income before' },
  f_income_after: { hi: 'अब की आय', en: 'Income after' },
  f_how_helped_hi: { hi: 'कैसे मदद की (हिंदी)', en: 'How helped (Hindi)' },
  ...
  // ===================== मौसम (/mausam) & MSP (/msp) pages =====================
  page_explainer_title: { hi: 'यह पेज किस लिए है', en: 'What this page is for' },
  under_review: { hi: 'समीक्षाधीन', en: 'Under review' },
  no_data: { hi: 'अभी डेटा उपलब्ध नहीं', en: 'No data available yet' },
  daily_see: { hi: 'रोज़ देखें', en: 'See daily' },
  kmh: { hi: 'किमी/घंटा', en: 'km/h' },
  hours_short: { hi: 'घंटे', en: 'h' },
  days_short: { hi: 'दिन', en: 'd' },
  month_short: { hi: 'माह', en: 'mo' },
  qtl: { hi: 'क्विंटल', en: 'quintal' },
  tonnes: { hi: 'टन', en: 't' },
  col_date: { hi: 'तारीख़', en: 'Date' },
  col_day: { hi: 'दिन', en: 'Day' },
  col_maxmin: { hi: 'अधि/न्यून', en: 'Max/Min' },
  col_rain: { hi: 'बारिश', en: 'Rain' },
  col_mandi: { hi: 'मंडी', en: 'Mandi' },
  col_modal: { hi: 'मॉडल भाव', en: 'Modal price' },
  col_diff: { hi: 'अंतर', en: 'Diff' },
  data_from: { hi: 'डेटा उपलब्ध:', en: 'Data from:' },
  msp_above: { hi: 'MSP से ऊपर', en: 'Above MSP' },
  msp_below: { hi: 'MSP से नीचे', en: 'Below MSP' },
  msp_above_short: { hi: 'ऊपर', en: 'above' },
  msp_below_short: { hi: 'नीचे', en: 'below' },
  ...
  signup_need_consent: { hi: 'कृपया सहमति का बॉक्स चुनें', en: 'Please tick the consent box' },
  signup_thanks: { hi: 'धन्यवाद — जल्द शुरू होगा।', en: 'Thank you — starting soon.' },
  crop_gehun: { hi: 'गेहूं', en: 'Wheat' }, crop_soyabean: { hi: 'सोयाबीन', en: 'Soybean' },
  crop_chana: { hi: 'चना', en: 'Gram' }, crop_masoor: { hi: 'मसूर', en: 'Lentil' },
  crop_moong: { hi: 'मूंग', en: 'Moong' }, crop_urad: { hi: 'उड़द', en: 'Urad' },
  crop_dhan: { hi: 'धान', en: 'Paddy' }, crop_makka: { hi: 'मक्का', en: 'Maize' },
  ...
  aw_ok: { hi: 'ठीक', en: 'OK' }, aw_caution: { hi: 'सावधानी', en: 'Caution' }, aw_stop: { hi: 'रुकें', en: 'Stop' },
  aw_spray_stop_rain: { hi: '6 घंटे में बारिश — दवा बह जाएगी', en: 'Rain within 6h — spray will wash off' },
  aw_spray_stop_wind: { hi: 'हवा तेज़ — छिड़काव न करें', en: 'Wind too strong — do not spray' },
  aw_spray_caution: { hi: 'बारिश/हवा की संभावना — ध्यान से', en: 'Possible rain/wind — be careful' },
  aw_spray_ok: { hi: 'सुबह 7–10 बजे सबसे अच्छा', en: 'Best 7–10 am' },
  aw_irrig_stop: { hi: '48 घंटे में अच्छी बारिश — सिंचाई रोकें', en: 'Good rain in 48h — hold irrigation' },
  aw_irrig_caution: { hi: 'मिट्टी में नमी अभी ठीक', en: 'Soil moisture is adequate now' },
  aw_irrig_ok: { hi: 'मौसम सूखा — सिंचाई ठीक', en: 'Dry weather — irrigation is fine' },
  aw_harvest_stop: { hi: '48 घंटे में बारिश — कटी फसल ढकें', en: 'Rain in 48h — cover the harvest' },
  aw_harvest_caution: { hi: '72 घंटे में बारिश की संभावना', en: 'Rain possible within 72h' },
  aw_harvest_ok: { hi: 'कटाई/सुखाई के लिए अच्छा दिन', en: 'A good day for harvest/drying' },
  ...
  mausam_season_rain: { hi: 'इस सीज़न की बारिश', en: 'This season’s rainfall' },
  mausam_16day: { hi: '16 दिन का अनुमान', en: '16-day outlook' },
  mausam_glossary_h: { hi: 'मौसम को समझें', en: 'Understand the weather' },
  mausam_signup_h: { hi: 'रोज़ सुबह अपने गाँव का मौसम WhatsApp पर पाएँ — पायलट के दौरान मुफ़्त', en: 'Get your village weather on WhatsApp every morning — free during the pilot' },
  mausam_rain_next: { hi: 'अगली बारिश', en: 'Next rain' },
  mausam_rain_now: { hi: 'अभी', en: 'now' },
  mausam_rain_after: { hi: 'बाद', en: 'later' },
  mausam_rain_in: { hi: 'बारिश', en: 'rain' },
  mausam_no_rain_48: { hi: 'अगले 48 घंटे बारिश नहीं', en: 'No rain in the next 48 hours' },
  mausam_todate: { hi: 'अब तक', en: 'To date' },
  mausam_normal: { hi: 'पिछले 10 साल का औसत', en: '10-year average' },
  mausam_rain_above: { hi: 'अब तक सामान्य से {n}% ज़्यादा', en: '{n}% above normal so far' },
  mausam_rain_below: { hi: 'अब तक सामान्य से {n}% कम', en: '{n}% below normal so far' },
  ...
  gloss_orange: { hi: 'IMD नारंगी = 115.5–204.5 मिमी — तैयारी रखें।', en: 'IMD Orange = 115.5–204.5 mm — be prepared.' },
  gloss_red: { hi: 'IMD लाल = 204.5 मिमी से ऊपर — कार्रवाई करें।', en: 'IMD Red = above 204.5 mm — take action.' },
  gloss_derived: { hi: 'हमारा बैज इन्हीं सीमाओं से बनता है, पर यह IMD की आधिकारिक चेतावनी नहीं।', en: 'Our badge is derived from these thresholds but is not an official IMD warning.' },
  gloss_trust: { hi: '2–3 दिन का अनुमान भरोसेमंद; 7 दिन से आगे बदल सकता है।', en: '2–3 day forecasts are reliable; beyond 7 days they can change.' },
  cropadv_gehun: { hi: 'रबी की मुख्य फसल। समय पर बुवाई नवंबर के पहले पखवाड़े में; क्रांतिक अवस्थाओं (जड़, कल्ले, फूल, दाना) पर सिंचाई ज़रूरी।', en: 'Main rabi crop. Sow in the first half of November; irrigate at critical stages (crown-root, tillering, flowering, grain).' },
  cropadv_chana: { hi: 'दलहन; कम सिंचाई में होती है। फूल-फली अवस्था में फली छेदक की निगरानी करें, ज़रूरत पर ही छिड़काव।', en: 'Pulse; needs little irrigation. Watch for pod borer at flowering/podding; spray only if needed.' },
  ...
  // --- msp ---
  msp_h1: { hi: 'भाव — आज व MSP से तुलना', en: 'price — today & MSP comparison' },
  msp_explain_1: { hi: 'यह पेज आज का मंडी भाव, सरकारी MSP, दोनों का फ़र्क और हफ्ते–महीने का रुझान दिखाता है।', en: 'This page shows today’s mandi price, the government MSP, the difference, and the weekly–monthly trend.' },
  msp_explain_2: { hi: 'स्रोत: Agmarknet / data.gov.in (मंडी भाव); CACP (MSP)।', en: 'Sources: Agmarknet / data.gov.in (mandi prices); CACP (MSP).' },
  msp_explain_3: { hi: 'उपयोग: बेचने से पहले देखें; MSP से नीचे हो तो नीचे दिए रास्ते देखें।', en: 'How to use: check before selling; if below MSP, see the routes below.' },
  msp_explain_4: { hi: 'हम भाव की भविष्यवाणी नहीं करते; मंडी में अंतिम भाव नीलामी से तय होता है।', en: 'We do not predict prices; the final mandi price is set by auction.' },
  msp_today_h: { hi: 'आज का भाव', en: 'Today’s price' },
  msp_last_price: { hi: 'अंतिम भाव', en: 'Last price' },
  msp_no_msp_crop: { hi: 'लहसुन पर MSP लागू नहीं होता — इसलिए MSP तुलना नहीं दिखाई गई।', en: 'Garlic has no MSP — so the MSP comparison is not shown.' },
  msp_trend_h: { hi: 'रुझान', en: 'Trend' },
  msp_trend_up: { hi: '{d} दिन में {n} चढ़ा', en: 'Up {n} in {d} days' },
  msp_trend_down: { hi: '{d} दिन में {n} गिरा', en: 'Down {n} in {d} days' },
  msp_calc_h: { hi: 'अभी बेचें या रोकें? — गणित', en: 'Sell now or hold? — the maths' },
  msp_calc_qty: { hi: 'मात्रा (क्विंटल)', en: 'Quantity (quintal)' },
  msp_calc_months: { hi: 'कितने महीने रोकेंगे?', en: 'Months to wait' },
  msp_calc_shortfall: { hi: 'MSP से अंतर', en: 'Difference vs MSP' },
  msp_calc_total: { hi: 'कुल अंतर', en: 'Total difference' },
  msp_calc_storage: { hi: 'रोकने पर गोदाम किराया', en: 'Storage cost if you hold' },
  msp_calc_est: { hi: 'अनुमान', en: 'estimate' },
  msp_calc_breakeven: { hi: 'बराबरी के लिए भाव इतना चढ़ना ज़रूरी', en: 'Price must rise this much to break even' },
  msp_calc_disclaimer: { hi: 'यह सिर्फ़ गणित है, भविष्यवाणी नहीं। फैसला आपका है।', en: 'This is only the maths, not a prediction. The decision is yours.' },
  msp_calc_godown: { hi: 'पास के गोदाम देखें', en: 'See nearby warehouses' },
  msp_procurement_h: { hi: 'MSP पर कहाँ बेचें', en: 'Where to sell at MSP' },
  msp_dates: { hi: 'तारीख़ें', en: 'Dates' },
  msp_dates_soon: { hi: 'तारीख़ें जल्द', en: 'Dates soon' },
  msp_euparjan_steps: { hi: 'e-Uparjan: समग्र ID + आधार से पंजीयन → पर्ची → केंद्र पर बिक्री → खाते में भुगतान।', en: 'e-Uparjan: register with Samagra ID + Aadhaar → slip → sell at the centre → payment to your account.' },
  msp_below_h: { hi: 'MSP से नीचे बिक गया?', en: 'Sold below MSP?' },
  msp_bhavantar_t: { hi: 'भावांतर भुगतान योजना (MP)', en: 'Bhavantar Bhugtan Yojana (MP)' },
  msp_bhavantar_d: { hi: 'राज्य सरकार MSP/निर्धारित दर और मंडी भाव का अंतर सीधे बैंक खाते में देती है। अधिसूचित फसलों व पंजीयन अवधि के लिए योजना पेज देखें।', en: 'The state pays the difference between MSP/set rate and the mandi price directly to your bank account. See the scheme page for notified crops and the registration window.' },
  msp_aasha_d: { hi: 'केंद्र की मूल्य-समर्थन योजना — अधिसूचित फसलों के लिए। विवरण योजना पेज पर।', en: 'Central price-support scheme for notified crops. Details on the scheme page.' },
  msp_complaint: { hi: 'तौल या भुगतान में गड़बड़ी? मंडी सचिव / किसान कॉल सेंटर 1800-180-1551 पर शिकायत करें।', en: 'Weighing or payment problem? Complain to the mandi secretary / Kisan Call Centre 1800-180-1551.' },
  msp_pastyears_h: { hi: 'पिछले सालों में', en: 'In past years' },
  msp_signup_h: { hi: 'भाव MSP से ऊपर जाए तो WhatsApp पर बताएँ — पायलट के दौरान मुफ़्त', en: 'Get a WhatsApp alert when the price rises above MSP — free during the pilot' },
  home_forecast_link: { hi: '5 दिन का पूर्वानुमान', en: '5-day forecast' },
  home_msp_link: { hi: 'पूरी सूची', en: 'Full list' },
  info_open_mausam: { hi: 'मौसम व 7-दिन पूर्वानुमान देखें', en: 'Open weather & 7-day forecast' },
  info_open_msp: { hi: 'मंडी भाव व MSP देखें', en: 'Open mandi prices & MSP' },
  admin_content_review: { hi: 'मौसम/MSP सामग्री समीक्षा', en: 'Mausam/MSP content review' },
  admin_reviewed: { hi: 'समीक्षा पूर्ण', en: 'Reviewed' },
  admin_mark_reviewed: { hi: 'समीक्षा पूर्ण चिह्नित करें', en: 'Mark reviewed' },
  admin_mark_unreviewed: { hi: 'समीक्षाधीन चिह्नित करें', en: 'Mark under review' },
  admin_subscriptions: { hi: 'अलर्ट सदस्यताएँ', en: 'Alert subscriptions' },
