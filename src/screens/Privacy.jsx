...
import { privacyPolicy } from '../lib/i18n/legal'

// Minimal, bilingual Privacy Policy placeholder (Hindi first). LEGAL REVIEW
// PENDING before public launch — see src/lib/i18n/legal.js.
  ...
  return (
    <div className="min-h-screen bg-stone-50">
      ...
      <main className="mx-auto max-w-3xl px-5 py-10">
        ...
        <h1 className="text-2xl font-bold text-stone-900">{t('privacy_title')}</h1>
        ...
        <div className="mt-6 space-y-6">
          {privacyPolicy.map((p, i) => (
            <div key={i} className="rounded-2xl border-2 border-stone-100 bg-white p-4">
