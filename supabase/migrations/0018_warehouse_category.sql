-- Kisan Sahyog — 0018 Warehouse & Storage category
--
-- Widen the category CHECK to admit 'warehouse' and add its create_listing
-- validation. Signature is unchanged from 0017 (9 args incl p_listing_source) so
...
alter table public.listings
  ...
  check (category in ('land', 'equipment', 'labor', 'drone_didi', 'bhusa', 'agri_inputs', 'warehouse'));
